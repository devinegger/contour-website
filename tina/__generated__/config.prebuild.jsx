      ...
      // ─── PAGES ────────────────────────────────────────────────
      {
        ...
        fields: [
          { name: "title", label: "Page title", type: "string", required: true },
          {
            ...
            type: "string",
            required: true,
            description: "The single main heading for this page. On pages that open with a Hero or Contact form, that block already renders the visible H1, so this value is not shown there \u2014 but it stays required so every new page leads with a real heading."
          },
